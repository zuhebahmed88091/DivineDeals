  ...
  return (
    <div className="navbar flex justify-around p-4 shadow-md">
      <div className="nav-logo flex items-center gap-2">
        ...
        <p className="text-gray-900 text-lg font-semibold">DivineDeals</p>
      </div>
      <ul className="nav-menu flex items-center list-none gap-x-16 text-gray-600 text-base font-medium">
        ...
        >
          Shop{" "}
          {menu === "shop" ? (
            <hr className="w-4/5 h-1 rounded-lg bg-red-500" />
          ) : (
            <></>
          )}{" "}
        </li>
      ...
      <div className="nav-login-cart flex items-center gap-x-16">
        <button className="w-24 h-8 border border-gray-600 rounded-full text-gray-600 text-sm font-medium bg-white hover:bg-gray-200 focus:outline-none focus:border-gray-700 focus:ring focus:ring-gray-300">
          Login
        </button>
